...
function GameProvider({ children }) {
  const [state, dispatch] = import_react.useReducer(gameReducer, initialState, () => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(GameContext.Provider, {
    value,
    children
  }, undefined, false, undefined, this);
}
function useGame() {
  const context = import_react.useContext(GameContext);
  if (!context) {
...
function ItemCard({ item }) {
  ...
  const [buyQuantity, setBuyQuantity] = import_react2.useState(1);
  const [sellQuantity, setSellQuantity] = import_react2.useState(1);
  const handleBuy = () => {
    if (buyQuantity > 0) {
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
    className: `border rounded-lg p-4 bg-blue-300/70`,
    children: [
      ...
      /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("button", {
                ...
                className: `flex-1 py-1 px-3 rounded text-sm font-medium transition ${item.stock === 0 ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-green-500 hover:bg-green-600 text-white"}`,
                children: [
                  "Eladás (+",
                  sellQuantity * item.sellPrice,
                  " Ft)"
                ]
              }, undefined, true, undefined, this)
            ]
          ...
          /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("button", {
            ...
            disabled: !canUpgrade,
            className: `w-full py-2 px-3 rounded text-sm font-medium transition ${canUpgrade ? "bg-purple-500 hover:bg-purple-600 text-white" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`,
            children: [
              "Upgrade (",
              Math.round(item.sellPrice ** 1.1),
              " Ft)"
            ]
          }, undefined, true, undefined, this)
        ]
...
function GameHeader() {
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("header", {
    className: "sticky top-0 bg-white text-black p-4 shadow-lg",
          ...
          /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
            children: [
              /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("h1", {
                ...
                children: "Teskándi húsbolt szimulátor"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("a", {
                href: "https:/github.com/ergfvdfgh/teskandihusbolt",
                target: "_blank",
                className: "bg-gradient-to-r text-[20px] font-bold from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text",
                children: "Link a repohoz"
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
...
function MainGame() {
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(jsx_dev_runtime3.Fragment, {
    children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
      className: "container mx-auto px-4 py-6 w-full md:w-[70%] bg-slate-600/90",
      children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
        children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
          className: "grid grid-cols-[repeat(auto-fit,minmax(256px,1fr))] gap-4",
          children: state.items.map((item) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(ItemCard, {
            item
...
function App() {
  const [expandedImageUrl, setExpandedImageUrl] = import_react3.useState("");
  const [isGoonCornerExpanded, setIsGoonCornerExpanded] = import_react3.useState(() => {
    const cached = localStorage.getItem("tierTradeGame_goonCornerExpanded");
    return cached ? JSON.parse(cached) : false;
  });
  const [isExpandedImageLoaded, setIsExpandedImageLoaded] = import_react3.useState(false);
  const hasFetchedExpandedImage = import_react3.useRef(false);
  const loadExpandedImage = import_react3.useCallback(() => {
    if (hasFetchedExpandedImage.current) {
      return;
    }
    hasFetchedExpandedImage.current = true;
    setIsExpandedImageLoaded(false);
    fetch("/nekosapi/v4/images/random?rating=suggestive").then((response) => response.json()).then((result) => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(GameProvider, {
    children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
      className: "relative min-h-screen bg-gray-900",
      children: [
        isLoading && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
        ...
        /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
          ...
          children: [
            /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(GameHeader, {}, undefined, false, undefined, this),
            /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(MainGame, {}, undefined, false, undefined, this)
          ]
        }, undefined, true, undefined, this),
        /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
          className: "fixed bottom-4 right-4 z-20 flex flex-col items-end space-y-2",
          children: [
            isGoonCornerExpanded && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
              ...
              children: [
                ...
                !isExpandedImageLoaded && expandedImageUrl && /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("span", {
...
import_client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx_dev_runtime4.jsxDEV(import_react4.StrictMode, {
  children: /* @__PURE__ */ jsx_dev_runtime4.jsxDEV(App_default, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this));
